...
define([
    ...
    return function (config) {
        ...
        $('in_custom_product').value = Object.toJSON(categoryProducts);
        ...
        function registerCategoryProduct(grid, element, checked) {
            if (checked) {
                if (element.positionElement) {
                    ...
                    console.log('categorychecked',element.value);
                }
            } else {
                if (element.positionElement) {
                    element.positionElement.disabled = true;
                    console.log('categorydisabled',element.value);
                }
        ...
        function categoryProductRowInit(grid, row) {
            ...
            if(checkbox) {
                var highlightedItems = document.querySelectorAll(".chosen-because-of-cat");
                highlightedItems.forEach(function(userItem) { 
                    if(userItem.innerHTML==checkbox.value) {
                        checkbox.disabled = true;
                        
                        $(row).className = customname
                    }
                });
            }
